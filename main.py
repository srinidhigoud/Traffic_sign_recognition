...
parser.add_argument('--lr2', type=float, default=0.01, metavar='LR',
                    help='learning rate (default: 0.01)')
parser.add_argument('--lr3', type=float, default=0.005, metavar='LR',
                    help='learning rate (default: 0.01)')
...
optimizer2 = optim.SGD(model.parameters(), lr=args.lr2, momentum=args.momentum)
optimizer3 = optim.SGD(model.parameters(), lr=args.lr3, momentum=args.momentum)
def train(epoch):
    model.train()
